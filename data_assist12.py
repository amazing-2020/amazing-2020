...
class DataProcess:
    ...
    def process_csv(self):
        ...
        '''
        with open(data_path, newline='', encoding="ISO-8859-1") as csvfile:
            output_file_path = "100.csv"
    ...
    def pro_skill_graph(self):
        ...
        for pro_id in range(len(problems)):
            ...
            tmp_skill = tmp_df_0['skill_id']
            pro_skill_adj.append([pro_id, tmp_skill, 1])
...
if __name__ == '__main__':
    data_folder = '2012-2013-data-with-predictions-4-final'
    min_inter_num = 3
